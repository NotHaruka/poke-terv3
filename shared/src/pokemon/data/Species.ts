...
import { MonsterSpecies, MonsterType, GrowthRate, EvolutionMethod, MonsterStats, MoveData, MoveCategory } from '../models/PokemonInstance.js';

export const MOVES_DATABASE: Record<number, MoveData> = {
  1: { id: 1, name: 'Headbutt', type: MonsterType.Normal, category: MoveCategory.Physical, power: 40, accuracy: 100, pp: 35, priority: 0, description: 'A physical charge attack.' },
  2: { id: 2, name: 'Flame Spark', type: MonsterType.Fire, category: MoveCategory.Special, power: 40, accuracy: 100, pp: 25, priority: 0, description: 'Fires small flames at the target.' },
  ...
  4: { id: 4, name: 'Vine Lash', type: MonsterType.Grass, category: MoveCategory.Physical, power: 45, accuracy: 100, pp: 25, priority: 0, description: 'Lashes out with sharp whip-like vines.' },
  ...
  8: { id: 8, name: 'Swift Dash', type: MonsterType.Normal, category: MoveCategory.Physical, power: 40, accuracy: 100, pp: 30, priority: 1, description: 'An extremely fast strike that hits first.' },
  ...
  12: { id: 12, name: 'Spark Bolt', type: MonsterType.Electric, category: MoveCategory.Special, power: 40, accuracy: 100, pp: 30, priority: 0, description: 'Jolts the target with electric currents.' },
};
